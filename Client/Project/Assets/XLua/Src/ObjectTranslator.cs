...
//#if UNITY_EDITOR
//        internal readonly Dictionary<int , string> unityObjs = new Dictionary<int , string>();
//#endif
...
//#if UNITY_EDITOR
//                if (unityObjs.ContainsKey(obj_index_to_collect))
//                {
//                    string name = unityObjs[obj_index_to_collect];
//                    unityObjs.Remove(obj_index_to_collect);
//                    GameDebug.LogGreen("collectObject:" + name);
//                }
//#endif
...
//#if UNITY_EDITOR
//                    udata = reverseMap[o];
//                    if (unityObjs.ContainsKey(udata))
//                    {
//                        string name = unityObjs[udata];
//                        unityObjs.Remove(udata);
//                        GameDebug.LogGreen("ReleaseCSObj:" + name);
//                    }
//#endif
