...
public class MapRenderer
{
    ...
    async UniTask GenerateTerrain()
    {
        ...
        {
            string assetPath = "Assets/Art/Tileset/Palettes/Brushes/isometric-tile_ground_03.asset";
        ...
        {
            string assetPath = "Assets/Art/Tileset/Palettes/Brushes/isometric-tile_ground_02.asset";
            Tile tile = await AssetManager.Instance.LoadAssetAsync<Tile>(assetPath); 
        ...
        {
            string assetPath = "Assets/Art/Tileset/Palettes/Brushes/isometric-tile_ground_01.asset";
            Tile tile = await AssetManager.Instance.LoadAssetAsync<Tile>(assetPath); 
        ...
        {
            string waterAssetPath = "Assets/Art/Tileset/Palettes/Brushes/isometric-tile_water_01.asset";
    ...
    async UniTask GenerateNature()
    {
        ...
        Grid grid = tileLayerData.tilemap.layoutGrid;
        GameObject template = AssetManager.Instance.LoadAsset<GameObject>("Assets/Art/Tileset/Prefabs/1x1.prefab");
        for (int i = 0; i < totalCount; i++)
        {
            ...
            inst.transform.SetParent(tileLayerData.gameObject.transform);
            int x = random.Next(-Width + 1, Width);
            int y = random.Next(-Height + 1, Height);
            Vector3Int cell = new Vector3Int(x, y, 0);
            Vector3 worldPos = grid.CellToWorld(cell);
            worldPos.y = worldPos.y + 0.25f;
            inst.transform.position = worldPos;

            int index = random.Next(0, objList.Count);
            SpriteRenderer renderer = inst.GetComponent<SpriteRenderer>();
            renderer.sprite = AssetManager.Instance.LoadAsset<Sprite>($"Assets/Art/Tileset/Sprites/{objList[index]}.png");
            renderer.sortingOrder = tileLayerData.renderer.sortingOrder;
        }
    }
