...
namespace UnityEngine.UI
{
    ...
    public class HollowOutMask : MaskableGraphic, ICanvasRaycastFilter
    {
        ...
        /// 设置镂空的目标
        /// </summary>
        public void SetTarget(RectTransform target, bool isPenetrate = false)
        {
        ...
        bool ICanvasRaycastFilter.IsRaycastLocationValid(Vector2 screenPos, Camera eventCamera)
        {
            ...
            if (!_isPenetrate) return true;
            // 将目标对象范围内的事件镂空（使其穿过）
            var flag = !RectTransformUtility.RectangleContainsScreenPoint(_target, screenPos, eventCamera);
